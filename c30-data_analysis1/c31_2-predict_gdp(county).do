...
xi i.year i.new_county_id
set matsize 11000

*** 4. Predict GDP
**Non-agriculture GDP
xtreg lg_nonagri lg_totalsol _Iyear_* _Inew_count_2-_Inew_count_2848, robust cluster(new_county_id)
...
forvalues i = 2/2848 {
    gen beta_county_`i' = _b[_Inew_count_`i']
}	
...
forvalues i = 2/2848 {
    ...
    qui gen temp_beta = beta_county_`i' if `county_var' == 1
...
**Agriculture GDP
xtreg lg_agri lg_ruralnpp _Iyear_* _Inew_count_2-_Inew_count_2848, robust cluster(new_county_id)
...
**GDP per capita
xtreg county_lggdppc lg_totalmol _Iyear_* _Inew_count_2-_Inew_count_2848, robust cluster(new_county_id)
